...
function DashboardPropriétaire() {
  ...
  // ✅ Chargement des propriétés depuis MongoDB
  const fetchProperties = useCallback(async () => {
    try {
      if (!user) return;
      // On récupère uniquement les biens du proprio connecté
      // Note: Ton backend doit filtrer par req.user.id
                    ...
                    <div className="flex-grow space-y-3 w-full">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button onClick={() => deleteProperty(property._id || property.id)} className="p-3 rounded-2xl bg-slate-50 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-all">
